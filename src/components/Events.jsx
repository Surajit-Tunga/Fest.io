...
const Event = () => {
  ...
  {eventList.map((data, index) => (
    <div
      key={index}
      className="bg-[#100420] border border-purple-500 rounded-2xl overflow-hidden shadow-md hover:shadow-purple-700 transition duration-300 w-full max-w-sm mx-auto"
    >
      {/* Image */}
      <img
        src={data.img}
      ...
      <div className="p-4 space-y-2">
        ...
        <a
          href="#"
          className="block mt-4 bg-white text-black text-center px-4 py-2 rounded-full text-sm font-semibold hover:bg-gray-100 transition"
        >
          Register Now
        </a>
      </div>
