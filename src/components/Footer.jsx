      ...
      <section className="max-w-[1200px] mx-auto">
        <div className="grid md:grid-cols-3 py-5">
          ...
          <div className="py-8 px-4">
            <h1 className="text-3xl text-orange-700 font-bold mb-2">Fest.io</h1>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 col-span-2 md:pl-10">
            <div className="py-8 px-4">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li><a className='hover:text-orange-600 transition' href="/events">Events</a></li>
                <li><a className='hover:text-orange-600 transition' href="/team">Team</a></li>
                <li><a className='hover:text-orange-600 transition' href="/contact">Contact Us</a></li>
              </ul>
            </div>
            ...
            <div className="py-8 px-4">
              ...
              <div className="space-y-4 text-sm leading-tight text-gray-300">
                <div className="flex items-start gap-3">
                  <HiLocationMarker className="text-lg mt-0.5 text-orange-600" />
                  <p>Kolkata,WB</p>
                </div>
                <div className="flex items-start gap-3">
                  <MdMessage className="text-lg mt-0.5 text-orange-600" />
                  <p>abc@gmail.com</p>
                </div>
                <div className="flex items-start gap-3">
                  <MdCall className="text-lg mt-0.5 text-orange-600" />
                  <p>+91 9876543210</p>
                </div>
              </div>
            </div>
        ...
        <div className="sm:block">
          <div className="flex flex-col sm:flex-row justify-between items-center py-6 border-t-2 border-gray-700">
            ...
            <div className="flex items-center justify-center gap-4 mt-4 sm:mt-0">
              ...
              >
                <FaInstagram className="text-2xl hover:text-orange-600 transition" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <FaFacebook className="text-2xl hover:text-orange-600 transition" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <FaLinkedin className="text-2xl hover:text-orange-600 transition" />
              </a>
            </div>
          </div>
        </div>
